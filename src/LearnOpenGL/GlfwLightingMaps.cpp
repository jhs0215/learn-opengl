...
GlfwLightingMaps::GlfwLightingMaps()
	: m_lightingShader("resources/shaders/4.2.lighting_maps.vs.glsl", "resources/shaders/4.2.lighting_maps.fs.glsl")
	, m_lightCubeShader("resources/shaders/4.2.light_cube.vs.glsl", "resources/shaders/4.2.light_cube.fs.glsl")
{
}
